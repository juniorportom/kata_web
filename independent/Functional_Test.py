...
class FunctionalTest(TestCase):
    ...
    def test_registro(self):
        ...
        correo.send_keys('rj.portocarrero@uniandes.edu.co')

        imagen = self.browser.find_element_by_id('id_imagen')
        imagen.send_keys('/Users/juniorportom/Downloads/logo-1.png')

        nombreUsuario = self.browser.find_element_by_id('id_username')
        nombreUsuario.send_keys('portocr123')
        ...
        span=self.browser.find_element(By.XPATH, '//span[text()="Junior Portocarrero"]')
        self.assertIn('Junior Portocarrero', span.text)
    ...
    def test_verDetalle(self):
        ...
        h2 = self.browser.find_element(By.XPATH, '//h2[text()="Junior Portocarrero"]')

        self.assertIn('Junior Portocarrero', h2.text)
